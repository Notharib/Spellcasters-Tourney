...
Name: Damage
Inherits: enum.Enum
Purpose: Enumerates damage constants
"""
...
class Projectile:
    ...
    Name: getProType
    Parameters: None
    Returns:self._ProType
    Purpose: Getter for the projectile type
    """
...
class Bullet(pygame.sprite.Sprite, Projectile):
    ...
    def __init__(
        ...
        element: str,
        size: list[int] = [10, 10],
        damage: int = Damage.PROJECTILE.value,
    ):
